...
def main(): 
    ...
    results = parse_attack_file(args)

    all_groups = get_groups_from_analyser(results)
    zt_rke2_group = get_group_times(all_groups,results.start_time)
    comp_groups = analyse_comparison("../module/Kit_Agent/100k_minimal.log")
